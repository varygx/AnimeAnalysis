...
# refer to README for more details and for resources to learn how to run the file
...
for (n in 0:(total_anime / num_anime - 1)) {
  ...
  for (i in 1:num_anime) {
    ...
    print(paste("Progress", i + n * 500, "/", total_anime))
  }
...
saveRDS(all_anime, "data/raw_data/anime_rankings.rds")
